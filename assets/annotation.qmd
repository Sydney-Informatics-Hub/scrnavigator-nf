...
cell_type_prop_table_mouse_main <- paste0("annotation_db/", cohort_id, ".cell_type_proportions.singleR_annotation.mouse_main.csv")
cell_type_prop_table_hpca_fine <- paste0("annotation_db/", cohort_id, ".cell_type_proportions.singleR_annotation.hpca_fine.csv")
cell_type_prop_table_mouse_fine <- paste0("annotation_db/", cohort_id, ".cell_type_proportions.singleR_annotation.mouse_fine.csv")
...
annotation_descriptions <- list(
  ...
  SingleR.mouse_main = "SingleR annotation with celldex mouse database ('main' cell type category)",
  SingleR.hpca_fine = "SingleR annotation with HPCA database ('fine' cell type category)",
  SingleR.mouse_fine = "SingleR annotation with celldex mouse database ('fine' cell type category)",
...
#| results: asis
#| echo: false
#| eval: !expr db_annotated && file.exists(cell_type_prop_table_mouse_main)
cat("##### Celldex Mouse Main annotations")
```
...
#| message: false
#| eval: !expr db_annotated && file.exists(cell_type_prop_table_mouse_main)
datatable(read_csv(cell_type_prop_table_mouse_main))
```

```{r}
#| results: asis
#| echo: false
#| eval: !expr db_annotated && file.exists(cell_type_prop_table_mouse_fine)
cat("##### Celldex Mouse Fine annotations")
```
...
#| message: false
#| eval: !expr db_annotated && file.exists(cell_type_prop_table_mouse_fine)
datatable(read_csv(cell_type_prop_table_mouse_fine))
```
